...
public class GameButtonsScript : MonoBehaviour
{
    ...
    public void Day_Night_Switch()
    {
        ...
        note1.GetComponent<SpriteMotion>().ChangeColor();
        note2.GetComponent<SpriteMotion>().ChangeColor();
        note3.GetComponent<SpriteMotion>().ChangeColor();
    }

    public void HorizontalButton()
    {
            note1.GetComponent<SpriteMotion>().FlipHorizontal();
            note2.GetComponent<SpriteMotion>().FlipHorizontal();
            note3.GetComponent<SpriteMotion>().FlipHorizontal();
    }

    public void VerticalButton()
    {
            note1.GetComponent<SpriteMotion>().FlipVertical();
            note2.GetComponent<SpriteMotion>().FlipVertical();
            note3.GetComponent<SpriteMotion>().FlipVertical();
    }
